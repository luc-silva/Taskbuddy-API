...
public class ProjectTaskResource {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateProjectTask(@PathVariable String id, @RequestBody ProjectTask projectTask){
        projectTaskService.updateProjectTask(projectTask, Integer.valueOf(id));
